...
?>
	      <div class="row">
            ...
            <div class="control-group">
              <i class="icon-zoom-in"></i> <input class="span5 m-wrap" id="appendedInputButton" type="text" placeholder="Qual variável você está buscando?">
            </div> <!-- /control-group -->
            </fieldset>
            </div>
            ...
            <table class="table table-striped table-bordered" id="tabela">
              ...
              $result_usuarios = "SELECT * FROM variaveis ORDER BY nome ASC";
