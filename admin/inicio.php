...
<div class="row">
  <div class="span6">
    ...
    <div class="widget widget-nopad">
      ...
      <div class="widget-content">
          ...
          <br>
          Você é um usuário com níveis de acesso de <b>Administrador Geral</b>.
          <br><br>
        </center>
      </div>
      <!-- /widget-content -->
  ...
  <div class="span6">
    <div class="widget">
      ...
      <!-- /widget-header -->
      <div class="widget-content">
        <div class="shortcuts"> <a href="javascript:;" class="shortcut"><i class="shortcut-icon icon-bar-chart"></i><span
                                  class="shortcut-label">Cadastrar planta</span> </a><a href="javascript:;" class="shortcut"><i
                                      class="shortcut-icon icon-group"></i><span class="shortcut-label">Associar planta com usuário</span> </a><a href="javascript:;" class="shortcut"><i class="shortcut-icon icon-zoom-in"></i> <span class="shortcut-label">Visualizar todas as plantas</span> </a><br><a href="javascript:;" class="shortcut"><i class="shortcut-icon icon-user"></i><span
                                          class="shortcut-label">Criar usuário</span> </a><a href="javascript:;" class="shortcut"><i
