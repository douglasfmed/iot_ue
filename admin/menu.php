      ...
      <ul class="mainnav">
        ...
        <li <?php if($pagina == 'plantas' || $pagina == 'plantas_cadastrar' || $pagina == 'plantas_gerenciar' || $pagina == 'associar_usuarios'){ echo "class=\"dropdown active\"";} else{ echo "class=\"dropdown\""; } ?>><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-bar-chart"></i><span>Plantas</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="index.php?p=plantas_cadastrar"><i class="icon-plus-sign"></i> Cadastrar</a></li>
            <li><a href="index.php?p=plantas_gerenciar"><i class="icon-pencil"></i> Gerenciar</a></li>
            <li><a href="index.php?p=associar_usuarios"><i class="icon-group"></i> Associar com usuários</a></li>
        ...
        <li <?php if($pagina == 'usuarios_cadastrar' || $pagina == 'usuarios_gerenciar'){ echo "class=\"dropdown active\"";} else{ echo "class=\"dropdown\""; } ?>><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-group"></i><span>Usuários</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
